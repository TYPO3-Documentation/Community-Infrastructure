:navigation-title: Policy for Teams and Committees
...
All members of a team have to respect the :ref:`code of conduct <coc>`. The Team and Committee Leaders have additionally to respect the :ref:`policy for teams <team-policy>`.
